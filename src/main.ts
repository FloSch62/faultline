...
const HOVER_CUES = ".game-card:not(.drag-ghost), .route-room:not([disabled]), .archetype, .relic-option, [data-forge], .transmit-button, .console-button, .title-menu button, .gold-button, .field-seal.targetable, .lesson-card, button.port-row, .port-stud, .hostile-plate[data-plate], .delivery-pick";
...
document.addEventListener("click", (event) => {
  ...
  // The far rail: a hostile's plate or strip row targets it (or receives the picked-up delivery),
