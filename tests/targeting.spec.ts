 ...
 * every living hostile stands on the far rail as a portrait with one plate under it: its name, next
 * move and health, read from the forecast, and nothing drawn over the portrait. */
