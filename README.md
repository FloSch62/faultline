...
- **Lore** on the main menu: the story of the Line in 13 illustrated chapters, with the two lore films ([The Night of the Fault](https://youtu.be/nOozrWGKD9A) and [Whoever Answers](https://youtu.be/kFDv-0kHv8g)) playing in place. The ending chapter stays sealed until a keeper reaches the Heart.
...
- `src/lore.ts` — the main menu's Lore book (canon in `docs/lore.md`, paintings in `public/art/lore/` recorded in `docs/art-lore-manifest.json`) and the two lore films' links.
